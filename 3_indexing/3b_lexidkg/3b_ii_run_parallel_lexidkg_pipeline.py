...
if IS_SAMPLE:
    ...
    JSON_OUTPUT_DIR = (BASE_DIR / "../../dataset/samples/3_indexing/3c_llm_json_outputs_lexidkg").resolve()
else:
    BATCHES_ROOT = (BASE_DIR / "../../dataset/3_indexing/3b_langchain_batches").resolve()
    JSON_OUTPUT_DIR = (BASE_DIR / "../../dataset/3_indexing/3c_llm_json_outputs_lexidkg").resolve()
