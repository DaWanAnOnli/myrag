...
NUM_FOLDERS = 6  # Change this to your desired number of folders
...
if IS_SAMPLE:
    ...
    DEST_DIR = (Path(__file__).resolve().parent / "../../dataset/samples/3_indexing/3a1_langchain_batches_days/").resolve()
else:
    SOURCE_DIR = (Path(__file__).resolve().parent / "../../dataset/3_indexing/3a_langchain_results/").resolve()
    DEST_DIR = (Path(__file__).resolve().parent / "../../dataset/3_indexing/3a1_langchain_batches_days/").resolve()
