...
GOOGLE_API_KEY = os.environ["GOOGLE_API_KEY_4"]
...
DEFAULT_LANGCHAIN_DIR = Path(r"C:\Users\ROKADE\Documents\Joel TA\myrag\dataset\3_indexing\3f1_langchain_whole_document_batches\4").resolve()
