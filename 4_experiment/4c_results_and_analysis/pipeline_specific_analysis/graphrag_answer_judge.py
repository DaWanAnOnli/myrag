...
CSV_FILE = Path("../../../dataset/4_experiment/4c_experiment_results/new/llm_judge_results_20251121-201921_no_10_graphrag_answer_judge_3rd.csv")

# Layer 1 folder containing the layer 2 experiment folders
LAYER1_FOLDER = Path("../../4b_retrieval/4b_i_lexidkg_graphrag/question_terminal_logs/no_10_answer_judge_3")

# Mapping of folder names to CSV column names
FOLDER_TO_COLUMN = {
    "no_10_graphrag_2_answer_judge_3rd": "graphrag_2_answer_judge_answer score",
    "no_10_graphrag_3_answer_judge_3rd": "graphrag_3_answer_judge_answer score",
    "no_10_graphrag_4_answer_judge_3rd": "graphrag_4_answer_judge_answer score",
    "no_10_graphrag_5_answer_judge_3rd": "graphrag_5_answer_judge_answer score",
}

# Output directory for results
OUTPUT_DIR = Path("results_10_answer_judge")
...
def extract_iterations_from_log(log_path: Path) -> int:
    ...
    Looks for lines like: "- Iterations used: 2 (cap=2)"
...
def main():
    print("Starting iteration analysis...")
