#!/usr/bin/env python3
"""
Answer Judge Iteration Analysis Script
...
CSV_FILE = Path("../../../dataset/4_experiment/4c_experiment_results/new/llm_judge_results_20251114-213638_no_9_naiverag_answer_judge.csv")

# Base directory that contains the 4 experiment folders
LAYER1_FOLDER = Path("../../4b_retrieval/4b_ii_naiverag/question_terminal_logs_naive_over_graph/no_9_answer_judge_1")


# Mapping of folder names to CSV column names
FOLDER_TO_COLUMN = {
    "no_9_naiverag_2_answer_judge_1250": "naiverag_2_answer_judge_answer score",
    "no_9_naiverag_3_answer_judge_1250": "naiverag_3_answer_judge_answer score",
    "no_9_naiverag_4_answer_judge_1250": "naiverag_4_answer_judge_answer score",
    "no_9_naiverag_5_answer_judge_1250": "naiverag_5_answer_judge_answer score",
}

# Output directory for results
OUTPUT_DIR = Path("answer_judge_analysis_results")
...
def extract_iterations_from_log(log_path: Path) -> int:
    """
    Extract the actual number of iterations executed from an Answer Judge log file.
    ...
    try:
        ...
        # Note: Answer Judge uses dashes "---" not equals "==="
        ...
        # Method 4: Look for individual iteration markers in summary
        # "  • Iter X:" in summary
...
def main():
    print("Starting Answer Judge Iteration analysis...")
    ...
    print("Answer Judge Iteration analysis complete!")
